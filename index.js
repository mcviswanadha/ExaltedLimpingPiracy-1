...
let userGuess = prompt.question(`Hi, I have chosen a number between 1 and ${maxRange}, you have ${maxGuesses} tries to guess it.\n`)
...
const playAgain = () => {
  ...
  if (playAgain === 'y'){
    ...
    let newGuess = prompt.question(`Hi, I have chosen a number between 1 and ${maxRange}, you have ${maxGuesses} tries to guess it.\n`);
    currentGuess = 0;
    guesses = 0;
